...
class Dataloader:
    def __init__(self, height=64, width=64):
        ...
        self.hru_sm_path = root_path + "sm_predictions/input_datasets/hru/split_14/"
    ...
    def load_all_datasets_in_memory(self, start_in=0, end_in=500):
...
if __name__ == '__main__':
    ...
    train_data, _ = my_loader.load_all_datasets_in_memory(0, 2)
